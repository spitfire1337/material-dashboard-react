...
function ActiveRepairs() {
  ...
  const fetchRepairs = async () => {
    setShowLoad(true);
    try {
      // Assuming this endpoint returns all repairs, filtering done client-side for flexibility
      // If backend supports filtering, query params should be added here
      const response = await fetch(`${vars.serverUrl}/repairs`, {
        credentials: "include",
      });
