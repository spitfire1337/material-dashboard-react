...
const ClosingTimeRepairPopup = () => {
  ...
  useEffect(() => {
    ...
    const onClosingTimeRepairs = (data) => {
    ...
    socket.on("closingTimeRepairs", onClosingTimeRepairs);

    return () => {
      socket.off("closingTimeRepairs", onClosingTimeRepairs);
    };
  }, [socket]);
  ...
  return (
    <Card
      sx={{
        ...
        maxWidth: "400px",
        padding: "1rem",
        backgroundColor: "#d32f2f", // Error color for urgency
        color: "white",
        boxShadow: 6,
        maxHeight: "80vh",
        overflowY: "auto",
        ...
        <MDBox display="flex" alignItems="flex-start" width="100%">
          ...
          <MDBox width="100%">
            <MDTypography variant="h6" color="white" fontWeight="medium">
              {repairs.length > 1 ? "After Hours Repairs" : "After Hours Repair"}
            </MDTypography>
            <MDTypography variant="body2" color="white" mb={1}>
              {repairs.length > 1
                ? `${repairs.length} repairs in progress after closing`
                : "Repair in progress after closing"}
            </MDTypography>
...
export default ClosingTimeRepairPopup;
